...
const TopBarConta = () => {
    ...
    return (
        <div style={{ background: '#2e3039', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.5rem 2rem', width: '100%' }}>
